      ...
      <Container>
        <div className="bg-white shadow-lg rounded-4 overflow-hidden">
          <Row className="g-0">
            ...
            >
              <Image
                src={bookData.imageUrl || "/public/no-image.svg"}
                fluid
                rounded
            ...
            <Col md={8} className="p-4">
              <div className="d-flex justify-content-between align-items-start mb-4">
                <h2 className="mb-0 text-dark">{bookData.name}</h2>
                <div>
                  <Button
              ...
              <div className="mb-3 text-muted">
                <div className="d-flex mb-2 align-items-center">
                  <span className="fw-bold me-3 text-dark">작가</span>
                  <span>{bookData.author}</span>
                </div>
                <div className="d-flex mb-2 align-items-center">
                  <span className="fw-bold me-3 text-dark">출판사</span>
                  <span>{bookData.publisher}</span>
                </div>
                <div className="d-flex mb-2 align-items-center">
                  <span className="fw-bold me-3 text-dark">출판연도</span>
                  <span>
                    {bookData.publishDate
                      ? new Date(bookData.publishDate).getFullYear()
                      : "미상"}
                  </span>
                </div>
                <div className="d-flex mb-2 align-items-center">
                  <span className="fw-bold me-3 text-dark">가격</span>
                  <span>{bookData.price}</span>
                </div>
              </div>

              <div className="d-flex align-items-center mb-4">
                <span className="fw-bold me-3 text-dark">별점</span>
                <Rating
                  value={bookData.star}
                  precision={0.5}
